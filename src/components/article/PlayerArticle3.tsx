    ...
    <div className={props.className}>
      <div className="flex flex-row items-center">
        <div className="flex flex-col items-center">
          <span className="text-[14px] !leading-[16px] md:text-lg text-primary md:text-[#8F6BE8]">
            03
          </span>
          <div className="bg-purple md:bg-white w-[19px] h-[5px] rounded-[2.5px] mt-[1px] md:mt-1" />
        </div>
